class Date:
    def _init_(self, jour, mois, annee):
...
class OffreVoyage:
    def _init_(self, ref_offre, ville_depart, ville_arrivee):
...
class Hebergement:
    def _init_(self, date_debut, nbre_de_nuit, type_hebergement, prix_nuit):
...
class OffreTransportAllerSimple(OffreVoyage):
    def _init_(self, ref_offre, ville_depart, ville_arrivee, date, prix):
        ...
        super()._init_(ref_offre, ville_depart, ville_arrivee)
...
class Offre_Transport_Aller_Retour(Offre_Transport_Aller_Simple):
    def init(self,Ref_offre,Ville_depart, Ville_arrivee ,date ,date_arrivee, Prix ):
        super().init(Ref_offre,Ville_depart, Ville_arrivee ,date,Prix)
...
# Appeler la méthode Affichage_Aller_simple de la classe parentale pour afficher les informations communes
...
class Formule_complet(Offre_Transport_Aller_Retour,Hebergement):
    def init(self,Ref_offre='',Ville_depart='', Ville_arrivee='' ,date=Date(0,0,0), Prix=0,date_depart=Date(0,0,0),Type='' ,date_arrivee=Date(0,0,0), Date_debut=Date(0,0,0),Nbre_de_nuit=0,Prix_nuit=0):
# Appeler les constructeurs de classes mères pour initialiser les attributs
        Offre_Transport_Aller_Retour.init(self,Ref_offre,Ville_depart, Ville_arrivee ,date,date_depart ,date_arrivee, Prix)
        Hebergement.init(self,Date_debut,Nbre_de_nuit,Type,Prix_nuit)
...
# Définir l'attribut Etat_Réservation comme « Annulée »
